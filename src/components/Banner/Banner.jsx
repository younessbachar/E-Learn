        ...
        <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0">
                ...
                <div className='flex flex-col justify-center text-center md:text-left space-y-4 lg:max-w-[500px]'>
                    ...
                    initial="hidden"
                    whileInView={"visible"}
                    className='text-xl text-orange-600 font-semibold capitalize'>{tag}</motion.p>
                    <motion.p
                     variants={SlideUp(0.7)}
                     initial="hidden"
                     whileInView={"visible"}
                    className='text-xl lg:text-3xl font-semibold capitalize'>{title}</motion.p>
                    <motion.p
                     variants={SlideUp(0.9)}
                     initial="hidden"
                     whileInView={"visible"}
                    className='text-base text-slate-500'>{subtitle}</motion.p>
                    <motion.div
