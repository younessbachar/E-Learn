...
const Hero = () => {
  return (
    <>
     <div className="container md:mx-10 lg:mx-20 grid grid-cols-1 md:grid-cols-2 md:gap-60 min-h-[650px] relative">
        {/* brand info */}
        <div className='flex flex-col justify-center py-14 md:pr-16 xl:pr-25 md:py-0'>
         <div className='text-center md:text-left space-y-6'>
           ...
           initial= "hidden"
           animate= "visible"
           className='text-5xl font-semibold xl:text-7xl !leading-tight'>Find Your Perfect <span className='text-primary'>Tutor</span></motion.h1>
           <motion.p
